    ...
    <div className="flex flex-col items-center justify-center py-12 space-y-4">
      ...
      <div className="relative">
        <div className={`${sizeClasses[size]} border-4 border-gray-700 rounded-full animate-spin`}>
          <div className="absolute inset-0 border-4 border-transparent border-t-lol-gold rounded-full animate-spin" style={{ animationDuration: '1s' }}></div>
        </div>
        ...
        <div className={`absolute inset-2 border-2 border-gray-600 rounded-full animate-spin`} style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}>
          <div className="absolute inset-0 border-2 border-transparent border-r-lol-gold/70 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
        </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm mt-1">Summoning data from the Rift...</p>
      </div>
    </div>
  );
}
